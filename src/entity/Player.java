...
//        up1 = setup("/player/luffy_up1",gp.tileSize,gp.tileSize);
//        up2 = setup("/player/luffy_up2",gp.tileSize,gp.tileSize);
//        down1 = setup("/player/luffy_down1",gp.tileSize,gp.tileSize);
//        down2 = setup("/player/luffy_down2",gp.tileSize,gp.tileSize);
//        left1 = setup("/player/luffy_left1",gp.tileSize,gp.tileSize);
//        left2 = setup("/player/luffy_left2",gp.tileSize,gp.tileSize);
//        right1 = setup("/player/luffy_right1",gp.tileSize,gp.tileSize);
//        right2 = setup("/player/luffy_right2",gp.tileSize,gp.tileSize);
    ...
    public void update(){
        ...
        if(knockBack == true){
            ...
            // check ineteractive tile collision
