...
public class EventHandler {
    ...
    public void setDialogue(){
        ...
        eventMaster.dialogues[1][0] = "Bạn đã uống nước thánh \nBạn đã được hồi máu và năng lượng.\n"
                    + "(Quá trình đã được lưu lại)";
        eventMaster.dialogues[1][1] = "Ui! Nước ngon vậy";
    }
...
//            if(hit(24, 12, "right") == true){damagePit(24,12,gp.dialogueState);}
